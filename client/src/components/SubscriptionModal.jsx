        ...
        <div className="p-6 space-y-5">
          ...
          {isSubscribed && (
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full px-4 py-2.5 bg-teal-600 text-white rounded-lg hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition font-medium text-sm"
              >
          ...
          {isSubscribed ? (
            ...
            <button
              onClick={handleToggleSubscription}
              disabled={loading}
              className="w-full px-4 py-3 bg-teal-600 text-white rounded-lg hover:bg-teal-700 disabled:opacity-50 disabled:cursor-not-allowed transition font-semibold text-sm flex items-center justify-center gap-2"
            >
              <Bell size={18} />
              Enable Alerts
            </button>
