    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg font-medium flex items-center gap-2 transition ${isFilterOpen
        ...
        >
          ...
          Filters
          {activeFilterCount > 0 && (
            <span className="ml-1 px-2 py-0.5 bg-white text-teal-600 text-xs font-bold rounded-full">
              {activeFilterCount}
            </span>
          )}
          <ChevronDown
      ...
      <div
        className={`overflow-hidden transition-all duration-300 ease-in-out ${isFilterOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
          }`}
      >
