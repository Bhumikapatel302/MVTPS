...
const LiveTracking = () => {
  ...
  const loadVesselTrack = async (vesselId) => {
    try {
      const response = await api.get(`/vessels/${vesselId}/positions/?hours=24`);
